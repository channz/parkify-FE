        ...
        <div className="relative h-full w-full">
              ...
              <Card className="flex flex-col rounded-3xl drop-shadow-md">
                <CardContent className="p-4 space-y-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="font-semibold text-xl">Tunjungan Plaza</p>
                  </div>
                  <div className="flex flex-col">
                    <p className="font-medium text-lg">Email</p>
                    <p className="font-semibold text-xl">tpadmin@mail.com</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="flex flex-col rounded-3xl drop-shadow-md">
          ...
          <div className="absolute bottom-0 p-4 w-full">
            <div className="flex flex-col gap-5 w-full">
              ...
              <div className="flex flex-col">
                <ButtonSubmit button_value="Logout" button_icon={<LogOut />} />
              </div>
            </div>
          </div>
        </div>
